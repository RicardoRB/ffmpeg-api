...
router.get("/api/uploadposts/ffmpeg/jobs/:jobId", (req, res) => {
...
router.get("/api/uploadposts/ffmpeg/jobs/:jobId/download", (req, res) => {
  const jobId = req.params.jobId;
...
router.get("/api/uploadposts/ffmpeg/jobs", (req, res) => {
